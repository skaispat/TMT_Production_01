...
const confirmMarkDone = async () => {
  ...
  try {
    ...
    formData.append('sheetName', 'MGMT');
  ...
  const fetchSheetData = async () => {
    try {
      ...
      const response = await fetch(`https://docs.google.com/spreadsheets/d/1OML53kwf2UBXyp6beojKt1Nhn-bUS8iu8I4-AUz9ngE/gviz/tq?tqx=out:json&sheet=MGMT`);
  ...
  const handleImageUpload = async (id, e) => {
    ...
    // MGMT file in state temporarily
